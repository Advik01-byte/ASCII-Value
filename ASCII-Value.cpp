...
int main() {
  ...
  cout << "Do you want to get character from ASCII value or vice versa (Type y for character from ASCII value and n for vice versa)? ";
  cin >> ans;
  ...
  if (ans == 'y' || ans == 'Y') {
    ...
    if (binary == 'n' || binary == 'N') {
      ...
      cout << "ERROR. Wrong input entered, you can only type y or n." << endl;
    }
  } else {
    cout << "ERROR. Wrong input entered, you can only type y or n." << endl;
  }
